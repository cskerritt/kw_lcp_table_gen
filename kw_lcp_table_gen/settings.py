"""
Django settings for KW Life Care Plan Table Generator project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-m8zbMyNnmLwstNCxygrtGGLo5DQOTTMLzldRDYAz")
...
ROOT_URLCONF = "kw_lcp_table_gen.urls"
...
WSGI_APPLICATION = "kw_lcp_table_gen.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="kw_lcp_table_gen"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "kw_lcp_table_gen_language"
LANGUAGES = [
...
EMAIL_SUBJECT_PREFIX = "[KW Life Care Plan Table Generator] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "KW Life Care Plan Table Generator",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("KW Life Care Plan Table Generator"),
...
LOGGING = {
    ...
    "loggers": {
        ...
        "kw_lcp_table_gen": {
            "handlers": ["console"],
            "level": env("KW_LCP_TABLE_GEN_LOG_LEVEL", default="INFO"),
        },
    },
}
